...
def test_cpu_ins_inc_zp(value, expected, flag_z, flag_n) -> None:
    """
...
def test_cpu_ins_inc_zpx(value, expected, flag_z, flag_n) -> None:
    """
...
def test_cpu_ins_inc_abs(value, expected, flag_z, flag_n) -> None:
    """
...
def test_cpu_ins_inc_abx(value, expected, flag_z, flag_n) -> None:
    """
